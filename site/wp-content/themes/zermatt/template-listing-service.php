	...
	<main class="main">
		<div class="container">
			<div class="row">
				...
				<?php
					$cpt_taxonomy   = 'zermatt_service_category';
					$base_category  = get_post_meta( get_the_ID(), 'service_listing_base_category', true );
					$columns        = get_post_meta( get_the_ID(), 'service_listing_columns', true );
					$first_full     = get_post_meta( get_the_ID(), 'service_listing_first_fullwidth', true );
